...
The example  that we study in this lecture  is a key component of :doc:`this lecture <odu>`__ that augments the 
...
We'll use such graphs to provide insights into the mechanics driving outcomes in :doc:`this lecture <odu>`__ about learning in an augmented McCall job
search model.
